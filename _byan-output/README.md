# _byan-output/ - Index de navigation

Organisation des livrables BYAN pour le projet BOW.
...
### Agents BOW (`_byan/bow/agents/`)

Agents BOW specialises et contexte projet. Crees par BYAN. Migres sous `_byan/bow/`.

| Fichier | Agent | Domaine |
|---------|-------|---------|
| `_byan/bow/project-context-bow.yaml` | - | Contexte complet du projet (charge par tous les agents) |
| `_byan/bow/agents/bow-product-manager.md` | BOW-PM | Specs, regles metier, glossaire, 5 modules |
| `_byan/bow/agents/bow-architect.md` | BOW-ARCH | Architecture, Docker/Traefik, ADR |
| `_byan/bow/agents/bow-backend-expert.md` | BOW-BACK | Laravel 11, PostgreSQL, 150+ endpoints, TDD |
| `_byan/bow/agents/bow-frontend-expert.md` | BOW-FRONT | Next.js 15, Shadcn/ui, Zustand |
| `_byan/bow/agents/bow-qa-tester.md` | BOW-QA | Tests TDD, edge cases, permissions |
| `_byan/bow/agents/bow-devsecops.md` | BOW-SEC | Securite OWASP, hardening, secrets |
| `_byan/bow/agents/bow-github-expert.md` | BOW-GH | CI/CD, GitHub Actions, PRs |
| `_byan/bow/agents/bow-excel-specialist.md` | BOW-EXCEL | Import/export Excel, multi-sheet |
